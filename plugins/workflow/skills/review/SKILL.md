---
name: review
description: Review a proposed or completed code change for bugs, acceptance-criteria gaps, duplication, and missing test coverage.
---

# Review

Review the relevant code, tests, and requirements. Report only actionable findings.
